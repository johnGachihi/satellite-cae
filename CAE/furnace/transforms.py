...
class RandomResizedCropAndInterpolationWithTwoPic:
    """Crop the given image to random size and aspect ratio with random interpolation.
    ...
    def __init__(self, size, second_size=None, scale=(0.08, 1.0), ratio=(3. / 4., 4. / 3.),
                 interpolation='bilinear', second_interpolation='bilinear'):
    ...
    def __call__(self, img):
        ...
        if self.second_size is None:
            return F.resized_crop(img, i, j, h, w, self.size, Image.BICUBIC)
        else:
            return F.resized_crop(img, i, j, h, w, self.size, Image.BICUBIC), \
                   F.resized_crop(img, i, j, h, w, self.second_size, Image.BICUBIC)
